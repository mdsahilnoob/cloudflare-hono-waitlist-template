...
CREATE TABLE `__new_subscribers` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-03-15T17:08:26.230Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-15T17:08:26.230Z"' NOT NULL,
	`traffic_source` text,
	`device` text,
	`email_verified` integer,
	`unsubscribed` integer,
	`confirmation_token` text,
	CONSTRAINT "email_check" CHECK("__new_subscribers"."email" LIKE '%@%.%')
);
